...
def launch_client(server_info, client_yaml_path, 
                    namespace, core_client, app_client, client_id, containers_names):
    client_info = {}
            ...
            for dep in deps:
                ...
                if dep['kind'] == 'Deployment':
                    ...
                    dep['spec']['template']['spec']['containers'][0]['name'] = \
                          dep['spec']['template']['spec']['containers'][0]['name'].format(client_id)
...
def main(path, client_num, containers_names):
    ...
    for i in range(client_num):
        client_info = launch_client(server_info, client_yaml_path, namespace, core_client, app_client, i, containers_names)
...
if __name__ == '__main__':
    ...
    containers_names = ['yolo-demo-server']
